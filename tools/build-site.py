...
:root{
  --bg:#0e0e11; --surface:#16161b; --code-bg:#101014; --chip-bg:#222228;
  --border:#2b2b33; --divider:#232329;
...
.hero{background:linear-gradient(180deg,#121216,#0c0c0f)}
.card:hover{border-color:var(--accent-border);box-shadow:0 16px 44px rgba(0,0,0,.5)}
.chip.active{background:#f4f4f6;border-color:#f4f4f6;color:#0e0e11}
.btn-copy{background:#f4f4f6;color:#0e0e11}

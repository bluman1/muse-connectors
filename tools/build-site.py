...
/* ---------- detail panel ---------- */
.detail{margin:28px 40px 0;background:var(--surface);border:1px solid var(--border);border-radius:24px;padding:32px;display:flex;flex-direction:column;gap:24px}
...
<div class="wrap">
  <nav class="nav">
    <div class="brand">
      <video src="avatar/hatch.mp4" autoplay muted loop playsinline aria-label="Muse avatar"></video>
